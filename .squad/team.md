# Squad Team — Multi-Machine NixOS Configuration
...
|------|------|-------|---------|--------|
| Tony Stark | Lead | claude-opus-4.6 · premium | `.squad/agents/tonystark/charter.md` | 🟢 Active |
| Rocket Raccoon | Backend Dev | claude-sonnet-4.6 | `.squad/agents/rocketraccoon/charter.md` | 🟢 Active |
| Wanda Maximoff | Frontend Dev | claude-sonnet-4.6 | `.squad/agents/wandamaximoff/charter.md` | 🟢 Active |
| Bruce Banner | Tester | claude-sonnet-4.6 | `.squad/agents/brucebanner/charter.md` | 🟢 Active |
| Scribe | Session Logger | claude-haiku-4.5 · fast | `.squad/agents/scribe/charter.md` | 🟢 Active |
| Ralph | Work Monitor | claude-haiku-4.5 · fast | — | 🟢 Active |
...
Not yet configured. Awaiting GitHub repo connection.
